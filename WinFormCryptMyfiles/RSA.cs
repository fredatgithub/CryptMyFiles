...
namespace WinFormCryptMyfiles
{
  public static class RSA
  {
    ...
    public static string Encrypt(string text, string publicKeyXml, int keySize = 16384)
    {
    ...
    private static byte[] EncryptByteArray(byte[] data, string publicKeyXml, int keySize = 16384)
    {
    ...
    public static string Decrypt(string text, string publicAndPrivateKeyXml, int keySize = 16384)
    {
    ...
    private static byte[] DecryptByteArray(byte[] data, string publicAndPrivateKeyXml, int keySize = 16384)
    {
      if (data == null || data.Length == 0)
      {
        throw new ArgumentException("Data are empty", "data");
    ...
    public static int GetMaxDataLength(int keySize = 16384)
    {
    ...
    public static bool IsKeySizeValid(int keySize = 16384)
    {
      return keySize >= 384 &&
             keySize <= 16384 &&
             keySize % 8 == 0;
